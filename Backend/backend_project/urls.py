...
from meetings_api.views.meeting_item_view_latesttwoobjects import MeetingItemViewLatestTwoObjects
...
urlpatterns = [
    ...
    path('api/meeting/latest-two-object/' , MeetingItemViewLatestTwoObjects.as_view(), name='last-two-objects'),
]   
